...
const AgentsList = () => {
  ...
  return (
    <div className="p-4 bg-[#ece8e1]">
      ...
      <div
        className="mb-4 mx-8 bg-cover bg-center h-[100px] md:h-[120px]"
        style={{
      ...
      >
        <h2
          ...
          className="text-[#f2ffff] pl-4 py-3 tracking-wide md:tracking-normal text-4xl lg:text-6xl xl:text-7xl 2xl:text-8xl cursor-pointer flex items-center"
        ...
        >
          ...
          <img
            ...
            alt="Controllers"
            className="w-16 h-16 ml-4 bg-[#00314c] rounded-full"
          />
      ...
      >
        <h2
          ...
          className="text-[#8139e9] pl-4 py-3 tracking-wide md:tracking-normal text-4xl lg:text-6xl xl:text-7xl 2xl:text-8xl cursor-pointer flex items-center"
          style={{ fontFamily: "tungsten" }}
        >
          Initiators{" "}
          <img
            ...
            alt="Initiators"
            className="w-16 h-16 ml-4 bg-[#c7f459] rounded-full"
          />
      ...
      >
        <h2
          ...
          className="text-[#020224] pl-4 py-3 tracking-wide md:tracking-normal text-4xl lg:text-6xl xl:text-7xl 2xl:text-8xl cursor-pointer flex items-center"
          style={{ fontFamily: "tungsten" }}
        >
          Duelists{" "}
          <img
      ...
      >
        <h2
          ...
          className="text-[#eeb36c] pl-4 py-3 tracking-wide md:tracking-normal text-4xl lg:text-6xl xl:text-7xl 2xl:text-8xl cursor-pointer flex items-center"
          style={{ fontFamily: "tungsten" }}
        >
          Sentinels{" "}
          <img
            ...
            alt="Sentinels"
            className="w-16 h-16 ml-4 bg-[#2b0f03] rounded-full"
          />
