    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500 p-4 overflow-hidden">
            <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6 -mt-12"> 
                <h1 className="text-4xl font-bold text-center text-gray-700 -ml-0 md:-ml-7 pb-1 mb-4">Login</h1>
                <div className="flex flex-col justify-center space-y-6">
                    ...
                    <Link to="/signup">
                        <p className="text-center text-gray-600">
                            Don't have an account? <span className="text-indigo-600 hover:underline cursor-pointer">Sign up here</span>.
                        </p>
                    </Link>
