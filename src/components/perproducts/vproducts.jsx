        ...
        <div className='bg-gray-900 min-h-screen flex flex-col items-center'>
            <div className='flex flex-col items-center justify-center w-full bg-cover bg-center'>
                <div className="mt-10 mb-0"> 
                    <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl text-white text-center break-words max-w-screen-lg whitespace-normal lg:whitespace-nowrap' style={{ fontFamily: 'phasmain', textShadow: '3px 1px 10px rgba(0, 0, 0, 0.7)'}}>
                        AVAILABLE PRODUCTS
                    </h1>
                </div>
