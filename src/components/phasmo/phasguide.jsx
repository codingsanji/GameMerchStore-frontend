        ...
        <div className="relative">
            ...
            <div className="relative h-screen">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4 md:p-6">
                    <img src={Name} alt="Name" className="w-auto h-auto max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl" />
                    <p className="mt-4 text-base sm:text-lg md:text-xl lg:text-3xl"
            ...
            <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-full sm:w-4/5 md:w-3/4 lg:w-1/2 p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col items-start">
                    <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white mb-4" 
