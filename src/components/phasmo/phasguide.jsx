        ...
        <div className="relative">
            ...
            <div className="relative h-screen">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 2xl:p-14">
                    <img src={Name} alt="Name" className="w-auto h-auto max-w-s sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl" />
            ...
            <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-full sm:w-4/5 md:w-3/4 lg:w-1/2 xl:w-2/5 2xl:w-1/3 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 2xl:p-14 flex flex-col items-start">
                    <h1 className="text-base sm:text-lg md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-bold text-white mb-3" 
                        style={{ textShadow: '3px 1px 10px rgba(0, 0, 0, 2)' , fontFamily: 'spelite' }}>
                        OVER-VIEW
                    </h1>
                    <p className="text-xs sm:text-base md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-white mb-2 sm:mb-2 break-words"
            ...
            {/* Last Section */}
            <div className="relative h-screen flex flex-col items-center justify-center bg-cover bg-center mt-0.2" style={{ backgroundImage: `url(${Last})` }}>
