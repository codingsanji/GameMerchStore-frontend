  ...
  return (
    <div className="container max-w-full pt-12 pb-16 px-8 bg-gray-800">
      ...
      <div className="max-w-full mx-auto grid sm:grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col items-center p-4 sm:mt-1 md:mt-8"y>
          ...
          <div className="flex gap-4">
            <a
              href="/shop"
              className="bg-blue-500 text-white rounded-lg p-4 flex-1 text-center hover:bg-blue-600 transition duration-200"
            >
              Store
            </a>
            <a
              href="/valo"
              className="bg-green-500 text-white rounded-lg p-4 flex-1 text-center hover:bg-green-600 transition duration-200"
            >
              Valorant
            </a>
            <a
              href="/phasmo"
              className="bg-red-500 text-white rounded-lg p-4 flex-1 text-center hover:bg-red-600 transition duration-200"
            >
              Phasmophobia
            </a>
          </div>
        ...
        <div className="p-4 flex items-center">
          <div className="bg-gray-900 text-gray-100 shadow-lg rounded-lg p-6 sm:p-7 md:p-8 flex-1">
            <h1 className="text-2xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">
              To the Newbies,
            </h1>
            <h2 className="text-lg sm:text-xl md:text-xl font-normal mb-3 sm:mb-4">
              Hello there! We are{" "}
              <span className="text-orange-500">Gamerch</span> and we promote
              games while making fan-merch.
            </h2>
            <h2 className="text-lg sm:text-xl md:text-xl font-light mb-3 sm:mb-4">
              ...
              suggest game merch that we, as a fan community, want.
            </h2>
            <h2 className="text-lg sm:text-xl md:text-xl font-light mb-3 sm:mb-4">
              In the future, if this becomes a successful endeavor, with
              permission, we shall make the merch available for you to order!
            </h2>
            <h2 className="text-lg sm:text-xl md:text-xl font-light mb-3 sm:mb-4">
              Feel free to{" "}
              <Link to="#contact-us-section" className="text-orange-500">
                contact us
              </Link>{" "}
              (in the section before the footer) to suggest new games to try or
              merch ideas to create.
            </h2>
          </div>
        </div>
      </div>
