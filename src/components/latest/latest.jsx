...
>>>>>>> 139db2b85b7185c6c679d1fd883a7a678a6a3a85
        </div>
        ...
        <section className="introduction p-8 rounded-md mb-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white">
          <h3 className="text-3xl font-bold mb-4 text-center">To the Newbies,</h3>
          <p className="text-lg font-light text-center max-w-4xl mx-auto mb-6">
            Hello there! We are <span className="text-orange-500 font-bold">Gamerch</span> and we promote games while making fan-merch. <br />
            ...
            Feel free to contact us (in the section before the footer) to suggest new games to try or merch ideas to create.
            At the moment, we have Valorant and Phasmophobia merch on display. Happy exploring!
          </p>
        ...
        <section className="gallery p-8 rounded-md mb-8">
          <h2 className="shine text-4xl md:text-6xl font-bold mb-1 text-center">MINI GALLERY</h2>
          <h3 className="text-base md:text-lg text-center mb-3">Featuring a small collection of our products</h3>
